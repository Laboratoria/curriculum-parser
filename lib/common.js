...
internals.parseMeta = (metaToken, metaKeys, links) => {
  ...
  const html = exports.tokensToHTML([metaToken], links);
...
const linkProviders = [
  ...
  },
  {
    ...
    getElement: (document, a, urlObj) => {
      ...
      const src = urlObj.query ? `https://player.vimeo.com/video/${videoId}?${urlObj.query}?title=0&byline=0&portrait=0`
