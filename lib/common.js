...
internals.replaceLinkWithIframeSlide = ($, $el, iframe) => {
  const slidesContainer = $('<div class="slide-container">');
  slidesContainer.append(iframe);
  $el.replaceWith(slidesContainer);
};
